  ...
  return (
    <section className="hero">
        <div className="container1">
            <div className='left'>
              <h1><span>Biz bilan</span> aloqaga chiqing!</h1>
              <p>Hurmatli foydalanuvchilar, quyida bizning ma'lum manzillarimiz orqali istalgan mavzuyingiz va murojaatingiz bo'yicha biz bilan bog'lanishingiz mumkin. Biz har qanday murojjatingizga tayyormiz!</p>
              ...
              <div className="social-links">
                        ...
                        <a href="#" className="social-icon" aria-label="You Tube">
            ...
            <div className='right'>
              <img src="/Images/Rasmlar/HeroContact.png" alt="Hero Section of Contact Page" />
            </div>
        </div>
    </section>
  )
