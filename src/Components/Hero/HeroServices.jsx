  ...
  return (
    <section className="hero">
        <div className="container1">
            <div className='left'>
              <h1><span>Xizmatlarimiz </span>bilan tanishing!</h1>
              <p>Bizning yuqori darajadagi xizmatlarimizdan foydalaning, biz har qanday jismoniy va yuridik shaxslarga eng sifatli xizmatlarni taqdim etishga doim tayyormiz!</p>
            ...
            <div className='right'>
              <img src="/Images/Rasmlar/HeroServicess.png" alt="Hero Section of Services Page" />
            </div>
        </div>
    </section>
  )
