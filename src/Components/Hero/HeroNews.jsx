  ...
  return (
    <section className="hero">
        <div className="container1">
            <div className='left'>
              <h1><span>Yangiliklarimizdan</span> habardor bo'ling!</h1>
              <p>Platformada bo'layotgan yangiliklar doimiy joylanib boriladi, mijozlar, platforma va xizmatlar haqidagi yangiliklar bilan eng birinchilardan bo'lib tanishing!</p>
            ...
            <div className='right'>
              <img src="/Images/Rasmlar/Newss.png" alt="Hero Section of News Page" />
            </div>
        </div>
    </section>
  )
