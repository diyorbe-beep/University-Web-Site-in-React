  ...
  return (
    <section className="hero">
        <div className="container1">
            <div className='left'>
              <h1><span>ASTI</span> Interaktiv Xizmatlar Platformasi!</h1>
              <p>Hurmatli foydalanuvchilar, bu portal orqali ta'lim, ilm-fan, biznes va boshqa sohalardagi innovatsion xizmatlardan foydalanishingiz mumkin. Biz sizga eng yaxshi xizmatlarni taqdim etamiz.</p>
              <a href="#" className="batafsil">Batafsil</a>
              <div className="social-links">
                        <a href="https://www.facebook.com/andmiedu?__tn__=-UC*F" className="social-icon" aria-label="Facebook">
                        ...
                        <a href="https://t.me/Andmiedu1" className="social-icon" aria-label="Telegram">
                            <img src="/Images/Rasmlar/Telegram.webp" alt="Telegram"/>
                            <span className="icon-text">Telegram</span>
                        </a>
                        <a href="https://www.youtube.com/@andmieduuz" className="social-icon" aria-label="You Tube">
            ...
            <div className='right'>
              <img src="/Images/Rasmlar/HeroHome.png" alt="Hero Section of Home Page" />
            </div>
        </div>
    </section>
  )
