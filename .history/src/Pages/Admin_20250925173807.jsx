  ...
  return (
    <div className="admin-wrapper">
      ...
      <div className="admin-grid">
        ...
        <div className="admin-card">
          <h3 className="admin-subtitle">Buyurtmalar ({orders.length})</h3>
          {orders.length === 0 ? (
              ...
              <div key={o._id} className="order-item">
                <div className="order-main">
                  <div className="order-line">
                    <b>{o.firstName} {o.lastName}</b> — {o.phone} 
                    {o.userEmail && (<span className="order-email">({o.userEmail})</span>)}
                  </div>
                  <div className="order-line">{o.address}</div>
                  <div className="order-line">Xizmat: {o?.service?.name}</div>
                  {o.message && <div className="order-line">Izoh: {o.message}</div>}
